"""
Database initialization script for the Serving Layer.

Creates the MySQL schema (customers, cards, credit_card_types, transactions)
and seeds it with data from the CSV files in the dataset/ directory.
Run this once before starting the stream/batch pipeline.
"""
...
def main():
    """Connect to MySQL, create tables, and load all CSV data."""
