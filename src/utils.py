"""
Shared helper functions for the banking system.

Contains location proximity checks, credit score adjustment calculations,
and credit limit reduction logic used by both the stream and batch layers.
"""
