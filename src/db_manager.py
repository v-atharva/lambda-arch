"""
MySQL database connection and query helper.

Provides the DBManager class that reads credentials from the .env file,
manages a persistent MySQL connection, and exposes methods for executing
single and batch SQL queries used by all other modules.
"""
