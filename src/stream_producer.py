"""
Stream Layer (Producer) of the Lambda Architecture.

Loads transaction records from the MySQL database (or CSV fallback),
sorts them by timestamp, and publishes each transaction to the
'transactions_stream' Kafka topic for real-time consumer processing.
"""
...
def main():
    """Load transactions from the database and stream them to Kafka in order."""
